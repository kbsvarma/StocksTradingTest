...
case "$MODEL" in
  ...
  gemma4:31b) MODEL_SHA=6316f0629137b426c9d9b853ffc4c8209589f30ee39aebede6285096c0ff47e7 ;;
  *) echo 'Supported pinned models: qwen3.5:9b, gemma4:12b, qwen3.8:27b, gemma4:31b'; exit 1 ;;
esac
